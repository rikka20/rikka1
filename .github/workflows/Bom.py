...
def main():
	...
	try:
		...
		if pilih == '1':
			...
			print
			os.system('xdg-open http://wa.me/6285781782242?text=Hallo%20Min.%20Saya%20Nemu%20Kesalahan%20:%0A%0A')
			sleep(2)
			...
			print
			os.system('xdg-open https://www.youtube.com/c/BEBASKONTEN20')
			sleep(2)
